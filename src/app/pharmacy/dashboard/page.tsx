...
import { Gift, Banknote, History } from 'lucide-react';
...
export default function PharmacyDashboardPage() {
    ...
    useEffect(() => {
     ...
     const handleCommissionWithdrawal = () => {
        ...
        requestCommissionWithdrawal(user.id, user.fullName, withdrawalAmount);
      ...
      <main className="flex-1 bg-slate-50/50 pb-20 md:pb-0">
        <div className="container mx-auto py-12">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">View your analytics and manage earnings.</p>
            </div>
