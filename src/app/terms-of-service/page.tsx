        ...
        <div className="container mx-auto py-16">
           <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow">
            ...
            <div className="space-y-6 text-muted-foreground">
              ...
              <p>By using our platform, HealthLink Hub ("Platform"), you agree to be bound by these Terms of Service ("Terms"). This constitutes a legally binding agreement between you and HealthLink Hub. If you disagree with any part of the terms, then you may not access the Service. These Terms apply to all visitors, users, and others who access or use the Service, including Patients, Doctors, Pharmacies, Labs, and Health Coordinators (collectively, "Users").</p>
              
              <h2 className="text-xl font-bold text-foreground pt-4">2. Platform Services</h2>
              <p>HealthLink Hub is a technology platform that connects Users seeking healthcare services with independent third-party healthcare providers. We do not provide healthcare services ourselves. The platform facilitates appointment booking, communication, and a rewards system. We are not responsible for the professional advice, diagnosis, treatment, or services provided by any healthcare provider on the Platform.</p>
              ...
              <h2 className="text-xl font-bold text-foreground pt-4">5. Health Point Policy</h2>
                 <ul className="list-disc list-inside space-y-3 pl-4">
                    ...
                    <li><strong>Value:</strong> 1 Health Point is equivalent to INR 1. Health Points have no other cash value and cannot be exchanged for cash from HealthLink Hub.</li>
              ...
              <p>The Platform and its original content, features, and functionality are and will remain the exclusive property of HealthLink Hub and its licensors. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of HealthLink Hub.</p>
