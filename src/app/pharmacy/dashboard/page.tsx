...
import { Pill, Search, User, History, BadgePercent, Banknote, Gift, Loader2, Calendar, BellPlus, Trash2, LayoutDashboard, Beaker } from 'lucide-react';
        ...
        <div className="container mx-auto py-12">
            ...
            <Tabs defaultValue="dashboard" className="w-full">
                <TabsList className="grid w-full grid-cols-3 mb-6">
                    ...
                    <TabsTrigger value="tools"><Pill className="mr-2 h-4 w-4"/>Patient Tools</TabsTrigger>
                </TabsList>
