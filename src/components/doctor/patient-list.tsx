...
export const mockPatients = [
  ...
  { id: '2', name: 'Priya Mehta', clinic: 'Dadar', doctorId: '2', healthCoordinatorId: 'health_coordinator_1', appointmentDate: '2024-08-15T12:30:00Z', status: 'upcoming', consultation: 'Initial consultation for dermatology.', notes: 'Patient has a history of eczema.', consultationFee: 1500, refundStatus: 'Not Refunded', nextAppointmentDate: null, reviewed: false },
  { id: '3', name: 'Amit Singh', clinic: 'Bandra', doctorId: '3', healthCoordinatorId: 'health_coordinator_1', appointmentDate: '2024-08-14T15:00:00Z', status: 'done', consultation: 'Annual health check-up.', notes: 'All reports are normal.', consultationFee: 800, refundStatus: 'Refunded', nextAppointmentDate: '2025-08-14T15:00:00Z', reviewed: true },
  { id: '4', name: 'Sunita Patil', clinic: 'Andheri', doctorId: '1', healthCoordinatorId: null, appointmentDate: '2024-08-13T09:00:00Z', status: 'done', consultation: 'Post-operative follow-up.', notes: 'Wound healing well.', consultationFee: 950, refundStatus: 'Refunded', nextAppointmentDate: null, reviewed: false },
  { id: '5', name: 'Karan Verma', clinic: 'Dadar', doctorId: '2', healthCoordinatorId: 'health_coordinator_1', appointmentDate: '2024-08-16T11:00:00Z', status: 'upcoming', consultation: 'Vaccination appointment.', notes: '', consultationFee: 500, refundStatus: 'Not Refunded', nextAppointmentDate: null, reviewed: false },
  { id: '6', name: 'Anika Desai', clinic: 'Andheri', doctorId: '1', healthCoordinatorId: null, appointmentDate: '2024-08-12T16:00:00Z', status: 'done', consultation: 'Consultation for fever.', notes: 'Prescribed medication for viral infection.', consultationFee: 700, refundStatus: 'Refunded', nextAppointmentDate: '2024-09-12T16:00:00Z', reviewed: true },
  { id: '7', name: 'Vikram Reddy', clinic: 'Bandra', doctorId: '3', healthCoordinatorId: null, appointmentDate: '2024-08-17T14:00:00Z', status: 'upcoming', consultation: 'Physiotherapy session.', notes: 'Patient recovering from a sports injury.', consultationFee: 1800, refundStatus: 'Not Refunded', nextAppointmentDate: null, reviewed: false },
];
