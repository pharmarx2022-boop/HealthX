        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-6">
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <div>
                                    ...
                                    />
                                    <label htmlFor="cert-upload-lab" className={regNumberIsSet ? "cursor-not-allowed opacity-50 inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border border-input bg-background h-9 px-3 w-full" : "cursor-pointer inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 px-3 w-full"}>
                ...
                <Button type="submit" disabled={form.formState.isSubmitting || regNumberIsSet}>
                    {form.formState.isSubmitting ? <Loader2 className="animate-spin mr-2" /> : (regNumberIsSet ? 'Changes Saved' : 'Save Changes')}
                </Button>
            </div>
        </form>
    </Form>
